// Generar meditación Urge Surfing con ElevenLabs
import fs from 'fs';
...
const ELEVENLABS_API_KEY = 'sk_786acbfa90bd937260248dc8388bb96c4d7b9ddd3a4f702f';
const VOICE_ID = 'KGZeK6FsnWQdrkDHnDNA'; // English female voice

// Script completo con pausas SSML
const urgeSurfingScript = `<speak>
...
async function generateAudio() {
    try {
        console.log('Generando audio de Urge Surfing...');
        ...
        const outputPath = path.join(audioDir, 'urge_surfing.mp3');
